...
import { PAGE_BG, CARD, Th, Td, EmptyState, LoadingBox, BtnPrimary, BtnSecondary, Badge, pageContainer } from "../ui";
...
export default function CostFixerPage() {
  ...
  const runScan = useCallback(async () => {
    ...
    try {
      ...
      // Pre-select high-confidence proposals (>=0.8)
  ...
  async function applySelected() {
    ...
    try {
      ...
      // Remove applied items from the list
